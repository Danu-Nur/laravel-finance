    ...
    init: function () {
        ! function () {
            ...
            if (e) {
                ...
                i("#E4E6EF", t.lineWidth, 1), i(KTUtil.getCssVariableValue("--bs-danger"), t.lineWidth, 100 / 150), i(KTUtil.getCssVariableValue("--bs-primary"), t.lineWidth, .4)
            }
        }()
    }
};
                ...
                if (e) {
                    var t, a = function () {
                        ...
                        r.mapPolygons.template.setAll({
                            ...
                            toggleKey: "active",
                            interactive: !0
                        }), am5.ColorSet.new(t, {}), r.mapPolygons.template.set("fill", am5.color(KTUtil.getCssVariableValue("--bs-primary"))), r.mapPolygons.template.states.create("hover", {
...
var KTTablesWidget16 = function () {
    ...
    return {
        init: function () {
            ...
            v(b, "#kt_stats_widget_16_tab_link_5", "#kt_table_widget_16_chart_5_4", R, !1), KTThemeMode.on("kt.thememode.change", (function () {
    ...
    const l = () => {
        ...
        i = (t, l) => {
            t.forEach(((r, o) => {
                ...
                s.setAttribute("src", u + r.image + ".png"), n.innerText = r.name, d.innerText = r.description, m.innerText = r.cost, c.innerText = r.qty, g.innerText = r.total, r.stock > 10 ? f.innerHTML = '<div class="badge badge-light-success">In Stock</div>' : f.innerHTML = '<div class="badge badge-light-warning">Low Stock</div>', 1 === t.length || t.length;
                ...
                if (e) {
                    var t, a = function () {
                        ...
                        o.get("renderer").grid.template.setAll({
                            ...
                            fontSize: 13,
                            fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500"))
                        }), i("Cars", "cars", KTUtil.getCssVariableValue("--bs-primary")), i("Motorcycles", "motorcycles", KTUtil.getCssVariableValue("--bs-success")), i("Bicycles", "bicycles", KTUtil.getCssVariableValue("--bs-warning")), a.set("scrollbarX", am5.Scrollbar.new(t, {
                ...
                if (e) {
                    var t, a = function () {
                        ...
                        var f, u = g.children.push(am5.Label.new(t, {
                            ...
                            h = g.series.push(am5map.MapPolygonSeries.new(t, {
                                fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")),

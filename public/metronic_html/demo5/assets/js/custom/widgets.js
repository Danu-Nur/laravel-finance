        ...
        ! function () {
                        ...
                        a = function () {
                            ...
                            var a = KTUtil.getCssVariableValue("--bs-gray-500"),
                                ...
                                r = {
                                    ...
                                    colors: [KTUtil.getCssVariableValue("--bs-primary"), KTUtil.getCssVariableValue("--bs-info")],
                                    grid: {
                                        borderColor: o,
                                        strokeDashArray: 4,
                                        yaxis: {
            ...
            function () {
                ...
                [].slice.call(e).map((function (e) {
                    ...
                    t(a, e), KTThemeMode.on("kt.thememode.change", (function () {
            ...
            function () {
                ...
                if (e) {
                    var a = KTUtil.getCssVariableValue("--bs-gray-800"),
                        o = KTUtil.getCssVariableValue("--bs-gray-800"),
                        r = "dark" === KTThemeMode.getMode() ? KTUtil.getCssVariableValue("--bs-gray-200") : "#D6D6E0";
                    new ApexCharts(e, {
                        series: [{
                            name: "Net Profit",
                            data: [30, 25, 45, 30, 55, 55]

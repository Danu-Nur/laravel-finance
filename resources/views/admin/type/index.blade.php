    ...
    <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column py-1">
            ...
            <h1 class="d-flex align-items-center my-1">
                <span class="text-gray-900 fw-bold fs-1">List Types</span>
            </h1>
            <!--end::Title-->
        </div>
        <!--end::Page title-->
                    ...
                    @foreach ($type as $types)
                        <tr>
                            <td class="text-center pe-0">
                                <span class="fw-bold">{{ $types->id }}</span>
                            </td>
                            <td class="text-center">
                                <span class="fw-bold">{{ $types->name }}</span>
                            </td>
                            <td class="text-center">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="{{ route('type.show', $types->id) }}" class="menu-link px-3">View</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{{ route('type.edit', $types->id) }}" class="menu-link px-3">Edit</a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="{{ route('type.destroy', $types->id) }}" class="menu-link px-3"

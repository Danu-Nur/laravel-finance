        ...
        <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-5">
            ...
            <div class="card card-flush h-md-50 mb-5 mb-xl-5">
                ...
                <div class="card-header pt-5">
                    ...
                    <div class="card-title d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center">
                            <!--begin::Amount-->
                            <span class="fs-2 fw-bold text-gray-900 me-2 lh-1 ls-n2">Balance</span>
                            <!--end::Amount-->
                        </div>
                        <!--end::Info-->
                    </div>
                ...
                <div class="card-body pt-2 pb-4 d-flex align-items-center">
                    ...
                    <div class="d-flex flex-center me-5 pt-2">
                        ...
                        <img src="{{ asset('image/icon/wallet.png') }}" class="h-100px mb-3" alt="" />
                    </div>
                    <!--end::Chart-->
                    <!--begin::Labels-->
            ...
            <div class="card card-flush h-md-50 mb-xl-10">
                ...
                <div class="card-body pt-2 pb-4 d-flex align-items-center">
                    ...
                    <div class="d-flex flex-center me-5 pt-2">
                        {{-- <div id="kt_card_widget_4_chart" style="min-width: 70px; min-height: 70px" data-kt-size="70" data-kt-line="11"></div> --}}
                        <img src="{{ asset('image/icon/indonesian-rupiah.png') }}" class="h-100px mb-3" alt="" />
                    </div>
                    <!--end::Chart-->
                    <!--begin::Labels-->
                    <div class="d-flex flex-column content-justify-center w-100">
        ...
        <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-5">
            ...
            <div class="card card-flush h-md-50 mb-5 mb-xl-5">
                ...
                <div class="card-body pt-2 pb-4 d-flex align-items-center">
                    ...
                    <div class="d-flex flex-center me-5 pt-2">
                        {{-- <div id="kt_card_widget_4_chart" style="min-width: 70px; min-height: 70px" data-kt-size="70" data-kt-line="11"></div> --}}
                        <img src="{{ asset('image/icon/assets.png') }}" class="h-100px mb-3" alt="" />
                    </div>
                    <!--end::Chart-->
                    <!--begin::Labels-->
                    <div class="d-flex flex-column content-justify-center w-100">
            ...
            <div class="card card-flush h-md-50 mb-xl-10">
                ...
                <div class="card-body pt-2 pb-4 d-flex align-items-center">
                    ...
                    <div class="d-flex flex-center me-5 pt-2">
                        {{-- <div id="kt_card_widget_4_chart" style="min-width: 70px; min-height: 70px" data-kt-size="70" data-kt-line="11"></div> --}}
                        <img src="{{ asset('image/icon/flying-money.png') }}" class="h-100px mb-3" alt="" />
                    </div>
                    <!--end::Chart-->
                    <!--begin::Labels-->
                    <div class="d-flex flex-column content-justify-center w-100">
        ...
        <div class="col-lg-12 col-xl-12 col-xxl-3 mb-5 mb-xl-0">
            ...
            <div class="card card-flush overflow-hidden h-md-100">
                ...
                <div class="card-body d-flex justify-content-between flex-column pb-1 px-0">
                    ...
                    <div class="mixed-widget-4-chart" data-kt-chart-color="success" style="height: 300px"></div>
                    <!--end::Chart-->
                </div>
                <!--end::Card body-->
            </div>
                            ...
                            <div class="credit-card-front">
                                ...
                                <svg width="92" height="92" viewBox="0 0 92 92" fill="none"
                                    ...
                                    <g clip-path="url(#clip0_655_2157)">
                                        <rect x="0.437378" y="0.437515" width="91.125" height="91.125" rx="6.75"
                                            fill="white" />
                                        <path
                                    ...
                                    <defs>
                                        <clipPath id="clip0_655_2157">
                                            <rect x="0.4375" y="0.4375" width="91.125" height="91.125" rx="6.75"
                                                fill="white" />
                                        </clipPath>
                                    </defs>
                                </svg>
                                ...
                                <svg width="92" height="92" viewBox="0 0 92 92" fill="none"
                                    ...
                                    <g clip-path="url(#clip0_655_2795)">
                                        <rect x="0.4375" y="0.4375" width="91.125" height="91.125" rx="6.75"
                                            fill="white" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M12.25 42.7387L17.9445 49.9221L12.25 54.6408V42.7387Z" fill="#F15A23" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M14.5419 54.6411L18.8267 51.0566L21.7882 54.6411H14.5419Z" fill="#F15A23" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <div class="credit-card-front">
                                ...
                                <svg width="92" height="92" viewBox="0 0 92 92" fill="none"
                                    ...
                                    <g clip-path="url(#clip0_655_1633)">
                                        <rect x="0.4375" y="1.28125" width="91.125" height="91.125" rx="6.75"
                                            fill="white" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            ...
                                            fill="#003A70" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M53.0144 56.0238H55.1808V47.2453H53.0144V56.0238Z" fill="#003A70" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            ...
                                            fill="#003A70" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M62.4576 56.0238H64.6208V47.2453H62.4576V56.0238Z" fill="#003A70" />
                                    </g>
                                    <defs>
                                        <linearGradient id="paint0_linear_655_1633" x1="12.25" y1="56.2227"
                                            x2="79.7501" y2="56.2227" gradientUnits="userSpaceOnUse">
                            ...
                            <div class="credit-card-front">
                                ...
                                <svg width="92" height="92" viewBox="0 0 92 92" fill="none"
                                    ...
                                    <g clip-path="url(#clip0_655_2042)">
                                        <rect x="0.437378" y="0.4375" width="91.125" height="91.125" rx="6.75"
                                            fill="white" />
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                <svg width="92" height="92" viewBox="0 0 92 92" fill="none"
                                    ...
                                    <defs>
                                        ...
                                        <clipPath id="clip1_681_14892">
                                            <rect width="67.5" height="21.039" fill="white"
                            ...
                            <div class="credit-card-front">
                                ...
                                <svg width="92" height="92" viewBox="0 0 92 92" fill="none"
                                    ...
                                    <g clip-path="url(#clip0_681_15056)">
                                        <rect x="-0.00012207" width="91.125" height="91.125" rx="6.75"
                                            fill="white" />
                                    ...
                                    <defs>
                                        ...
                                        <clipPath id="clip1_681_15056">
                                            <rect width="67.5" height="19.2993" fill="white"
                                ...
                                <svg width="92" height="92" viewBox="0 0 92 92" fill="none"
                                    ...
                                    <defs>
                                        ...
                                        <clipPath id="clip1_681_14896">
                                            <rect width="67.5" height="29.5516" fill="white"
            ...
            <div class="card card-flush h-xl-100">
                ...
                <div class="card-body py-3">
                    ...
                    <div class="table-responsive">
                        <!--begin::Table-->
                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0" id="kt_ecommerce_sales_table">
                            <!--begin::Table head-->
                            <thead>
                                <tr>
                                    <th>Type</th>

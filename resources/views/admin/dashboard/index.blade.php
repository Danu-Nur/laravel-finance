        ...
        <div class="page d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_header" class="header align-items-stretch">
                ...
                <div class="container-fluid d-flex align-items-stretch justify-content-between">
                    <!--begin::Brand-->
                    <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0 w-lg-225px">
                        ...
                        <!--begin::Logo-->
                        <a href="index.html">
                            <i class="ki-duotone ki-dollar d-lg-inline" style="font-size: 5rem">
                                <span class="path1"></span>
                                <span class="path2"></span>
                                <span class="path3"></span>
                            </i>
                            {{-- <img alt="Logo" src="{{ asset('metronic_html/demo5') }}/assets/media/logos/demo5.svg"
                                class="d-none d-lg-inline h-30px theme-light-show" />
                            <img alt="Logo"
                                src="{{ asset('metronic_html/demo5') }}/assets/media/logos/demo5-dark.svg"
                                class="d-none d-lg-inline h-30px theme-dark-show" /> --}}
                            {{-- <img alt="Logo"
                                src="{{ asset('metronic_html/demo5') }}/assets/media/logos/demo5-mobile.svg"
                            ...
                            <div class="d-flex align-items-center ms-lg-5" id="kt_header_user_menu_toggle">
                                ...
                                <div class="btn btn-active-light d-flex align-items-center bg-hover-light py-2 px-2 px-md-3"
                                    ...
                                    <div class="symbol symbol-30px symbol-md-40px">
                                        <img src="{{ asset('metronic_html/demo5') }}/assets/media/avatars/300-1.jpg"
                                            alt="image" />
                                    </div>
                                    <!--end::Symbol-->
                                </div>
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                                    ...
                                    <div class="menu-item px-3">
                                        <div class="menu-content d-flex align-items-center px-3">
                                            ...
                                            <div class="symbol symbol-50px me-5">
                                                <img alt="Logo"
                                                    src="{{ asset('metronic_html/demo5') }}/assets/media/avatars/300-1.jpg" />
                                            </div>
                                            <!--end::Avatar-->
                                            <!--begin::Username-->
                                            ...
                                            <span class="menu-title position-relative">Language
                                                <span
                                                    ...
                                                    <img class="w-15px h-15px rounded-1 ms-2"
                                                        src="{{ asset('metronic_html/demo5') }}/assets/media/flags/united-states.svg"
                                                        alt="" /></span></span>
                                        </a>
                                        <!--begin::Menu sub-->
                                        <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="account/settings.html" class="menu-link d-flex px-5">
                                                    <span class="symbol symbol-20px me-4">
                                                        <img class="rounded-1"
                                                            src="{{ asset('metronic_html/demo5') }}/assets/media/flags/spain.svg"
                                                            alt="" />
                                                    </span>Spanish</a>
                                            </div>
                                            <!--end::Menu item-->
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="account/settings.html" class="menu-link d-flex px-5">
                                                    <span class="symbol symbol-20px me-4">
                                                        <img class="rounded-1"
                                                            src="{{ asset('metronic_html/demo5') }}/assets/media/flags/germany.svg"
                                                            alt="" />
                                                    </span>German</a>
                                            </div>
                                            <!--end::Menu item-->
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="account/settings.html" class="menu-link d-flex px-5">
                                                    <span class="symbol symbol-20px me-4">
                                                        <img class="rounded-1"
                                                            src="{{ asset('metronic_html/demo5') }}/assets/media/flags/japan.svg"
                                                            alt="" />
                                                    </span>Japanese</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                <a href="{{ asset('metronic_html/demo5') }}/account/settings.html"
                                                    class="menu-link d-flex px-5">
                                                    <span class="symbol symbol-20px me-4">
                                                        <img class="rounded-1"
                                                            src="{{ asset('metronic_html/demo5') }}/assets/media/flags/france.svg"
                                                            alt="" />
                                                    </span>French</a>
                                            </div>
                                            <!--end::Menu item-->
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-5">
                                        <a href="{{ asset('metronic_html/demo5') }}/authentication/layouts/corporate/sign-in.html"
            ...
            <div id="kt_content_container" class="d-flex flex-column-fluid align-items-stretch container-fluid">
                ...
                <div class="wrapper d-flex flex-column flex-row-fluid mt-5 mt-lg-10" id="kt_wrapper">
                    ...
                    <div class="content flex-column-fluid" id="kt_content">
                        <!--begin::Toolbar-->
                        {{-- <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7 pb-4" id="kt_toolbar">
                            <!--begin::Page title-->
                            <div class="card card-body">
                                <div class="page-title d-flex justify-content-center py-1">
                                    <!--begin::Title-->
                                    <h1 class="d-flex align-items-center my-1">
                                        <span class="fw-bold fs-1">My Balance: Rp.
                                ...
                                <div class="col-xxl-12">
                                    ...
                                    <div class="row g-5 g-xl-10">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="card card-flush h-xl-100" style="background-color: #caf6d2">
                                                <!--begin::Header-->
                                                <div class="card-header flex-nowrap pt-5">
                                                    <!--begin::Title-->
                                                    <h3 class="card-title align-items-start flex-column">
                                                        <span class="card-label fw-bold fs-2 text-gray-800">Balance</span>
                                                    </h3>
                                                    <!--end::Title-->
                                                </div>
                                                <!--end::Header-->
                                                ...
                                                <div class="card-body text-center p-0">
                                                    <!--begin::Image-->
                                                    <img src="{{ asset('image/icon/wallet.png') }}"
                                                        class="h-125px mb-3" alt="" />
                                                    <!--end::Image-->
                                                    <!--begin::Section-->
                                                    <div class="text-end pb-5 pe-5">
                                                        <span class="d-block mt-10 fw-bold fs-2 text-gray-800">Rp.
                                                            {{ number_format($sumTransactionIncome, 0, '', '.') }}</span>
                                                    </div>
                                                    <!--end::Section-->
                                                </div>
                                                <!--end::Body-->
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="card card-flush h-xl-100" style="background-color: #F6E5CA">
                                                ...
                                                <div class="card-header flex-nowrap pt-5">
                                                    <!--begin::Title-->
                                                    <h3 class="card-title align-items-start flex-column">
                                                        <span class="card-label fw-bold fs-2 text-gray-800">Income
                                                            (+)</span>
                                                    </h3>
                                                    <!--end::Title-->
                                                </div>
                                        ...
                                        <div class="col-md-3">
                                            <!--begin::Card widget 11-->
                                            <div class="card card-flush h-xl-100" style="background-color: #f1cfcf">
                                                <!--begin::Header-->
                                                <div class="card-header flex-nowrap pt-5">
                                                    <!--begin::Title-->
                                                    <h3 class="card-title align-items-start flex-column">
                                                        <span class="card-label fw-bold fs-4 text-gray-800">Expense
                                                            (-)</span>
                                                    </h3>
                                                    <!--end::Title-->
                                                </div>
                                                ...
                                                <div class="card-body text-center p-0">
                                                    ...
                                                    <div class="text-end pb-5 pe-5">
                                                        <span class="d-block mt-10 fw-bold fs-2 text-gray-800">Rp.
                                                            {{ number_format($sumTransactionExpense, 0, '', '.') }}</span>
                                                    </div>
                                                    <!--end::Section-->
                                                </div>
                                                <!--end::Body-->
                                        ...
                                        <div class="col-md-3">
                                            <!--begin::Card widget 11-->
                                            <div class="card card-flush h-xl-100" style="background-color: #bfd7e3">
                                                <!--begin::Header-->
                                                <div class="card-header flex-nowrap pt-5">
                                                    <!--begin::Title-->
                                                    <h3 class="card-title align-items-start flex-column">
                                                        <span class="card-label fw-bold fs-4 text-gray-800">My
                                                            Assets</span>
                                                    </h3>
                                                    <!--end::Title-->
                                                </div>
                                                ...
                                                <div class="card-body text-center p-0">
                                                    <!--begin::Image-->
                                                    <img src="{{ asset('image/icon/assets.png') }}"
                                                        class="h-125px" alt="" />
                                                    <!--end::Image-->
                                                    <!--begin::Section-->
                                                    <div class="text-end pb-5 pe-5">
                                                        <span class="d-block mt-10 fw-bold fs-2 text-gray-800">Rp.
                                                            {{ number_format($sumAsset, 0, '', '.') }}</span>
                                                    </div>
                                                    <!--end::Section-->
                                                </div>
                                                <!--end::Body-->
										...
										<div class="card card-xl-stretch mb-xl-8">
											...
											<div class="card-header border-0 py-5">
												...
												<div class="card-toolbar">
													...
													<!--begin::Menu 1-->
													<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_658cdc04f19cb">
														<!--begin::Header-->
														<div class="px-7 py-5">
														...
														<div class="px-7 py-5">
															...
															<div class="mb-10">
																...
																<!--begin::Input-->
																<div>
																	<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_658cdc04f19cb" data-allow-clear="true">
																		<option></option>
										...
										<div class="card card-xl-stretch mb-xl-8">
											...
											<div class="card-header border-0 py-5">
												...
												<div class="card-toolbar">
													...
													<!--begin::Menu 1-->
													<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_658cdc04f19d5">
														<!--begin::Header-->
														<div class="px-7 py-5">
															<div class="fs-5 text-gray-900 fw-bold">Filter Options</div>
														</div>
														...
														<div class="px-7 py-5">
															...
															<div class="mb-10">
																...
																<!--begin::Input-->
																<div>
																	<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_658cdc04f19d5" data-allow-clear="true">
																		<option></option>
																		<option value="1">Approved</option>
																		<option value="2">Pending</option>
																		<option value="2">In Process</option>
										...
										<div class="card card-xl-stretch mb-5 mb-xl-8">
											...
											<div class="card-header border-0 py-5">
												...
												<div class="card-toolbar">
													...
													<!--begin::Menu 1-->
													<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_658cdc04f19de">
														<!--begin::Header-->
														<div class="px-7 py-5">
															<div class="fs-5 text-gray-900 fw-bold">Filter Options</div>
														</div>
														...
														<div class="px-7 py-5">
															...
															<div class="mb-10">
																...
																<!--begin::Input-->
																<div>
																	<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_658cdc04f19de" data-allow-clear="true">
																		<option></option>
																		<option value="1">Approved</option>
																		<option value="2">Pending</option>
																		<option value="2">In Process</option>
                                                    ...
                                                    <div class="credit-card-front">
                                                        ...
                                                        <svg width="92" height="92" viewBox="0 0 92 92"
                                                            ...
                                                            <g clip-path="url(#clip0_655_2157)">
                                                                ...
                                                                <path d="M79.0109 36.8547L79.7499 54.0708H74.2502L74.2469 51.1182H70.4967L69.2624 54.0708H63.2979L69.5336 41.777L68.1275 41.7679L70.7992 36.8547H79.0109ZM74.2112 42.1215L72.0909 47.129H74.2751" fill="#0060AF" />
                                                                <path d="M47.9532 36.8549C50.6768 36.8702 52.2158 38.3486 52.2158 40.4842C52.2158 42.4529 50.5927 44.1957 48.8108 45.0968C50.6453 45.7711 50.804 47.4265 50.804 48.5977C50.804 51.4271 47.9648 54.071 44.2743 54.071H36.2258L39.3654 41.9485L38.0758 41.941L40.712 36.8549C40.712 36.8549 45.7384 36.8396 47.9532 36.8549ZM45.2811 43.835C45.8445 43.835 46.8392 43.6924 47.0879 42.602C47.3605 41.4185 46.4269 41.3866 45.9791 41.3866L44.379 41.3796L43.821 43.8351L45.2811 43.835ZM43.0189 46.8773L42.2821 49.7067H44.1662C44.9075 49.7067 45.9177 49.3388 46.1652 48.4181C46.4097 47.4946 45.7035 46.8773 44.9649 46.8773" fill="#0060AF" />
                                                            </g>
                                                            <defs>
                                                ...
                                                <div class="credit-card-inner">
                                                    <div class="credit-card-front">
                                                        ...
                                                        <svg width="92" height="92" viewBox="0 0 92 92" fill="none" xmlns="http://www.w3.org/2000/svg" class="logo">
                                                            ...
                                                            <rect x="0.4375" y="0.4375" width="91.125" height="91.125" rx="6.75" fill="white"/>
                                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M12.25 42.7387L17.9445 49.9221L12.25 54.6408V42.7387Z" fill="#F15A23"/>
                                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M14.5419 54.6411L18.8267 51.0566L21.7882 54.6411H14.5419Z" fill="#F15A23"/>
                                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M12.25 38.8956L13.736 40.7754L19.8461 48.4104L21.826 46.8337C21.826 46.8337 20.1823 44.8987 19.0787 42.7393C16.9209 38.5175 18.4486 35.889 18.4486 35.889H12.25V38.8956Z" fill="#F15A23"/>
                                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M20.7169 49.5888L22.7333 47.9232C22.7333 47.9232 24.6591 50.4583 26.8921 51.0566C29.8183 51.8407 31.1139 49.9224 31.1139 49.9224V54.6411H24.6867L26.1359 53.388C26.1359 53.388 25.3798 53.8921 23.5305 52.6112C22.439 51.8552 20.7169 49.5888 20.7169 49.5888Z" fill="#F15A23"/>
                                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M20.9025 35.875C20.9025 35.875 20.2592 36.7513 20.7171 38.8953C21.2065 41.187 23.1529 43.6125 23.1484 43.5582C23.1484 43.5582 23.2735 41.1498 24.6869 39.7365C27.6994 36.7239 31.1141 38.5172 31.1141 38.5172V35.8887L20.9025 35.875Z" fill="#F15A23"/>
                                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M31.1139 41.6935C31.1139 41.6935 29.2088 40.0616 27.5524 40.0616C25.4336 40.0616 24.2771 41.8909 24.2771 43.2178C24.2771 45.1505 25.2048 46.2245 26.136 47.1556C27.4741 48.4937 29.102 49.9369 31.1139 48.7754C31.1139 46.5769 31.1139 41.6935 31.1139 41.6935Z" fill="#F15A23"/>
                                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M52.8105 36.0719H57.3062C57.3062 36.0719 61.2888 42.1021 63.246 44.5935C65.2032 47.0849 67.31 49.9227 67.31 49.9227C67.31 49.9227 67.31 41.6934 67.31 37.4224C67.31 36.8825 65.8925 36.0719 65.8925 36.0719H71.0766C71.0766 36.0719 69.3756 36.7708 69.3756 37.4224C69.3756 42.7394 69.3756 55.6075 69.3756 55.6075C69.3756 55.6075 67.7434 54.7023 65.8925 52.5516C63.8129 50.1351 56.4152 40.379 56.4152 40.379C56.4152 40.379 56.4152 49.5891 56.4152 53.0154C56.4152 53.6625 57.8327 54.6414 57.8327 54.6414H52.8105C52.8105 54.6414 54.1876 53.6546 54.1876 53.0154C54.1876 48.4105 54.1876 41.6934 54.1876 37.4224C54.1876 36.8485 52.8105 36.0719 52.8105 36.0719Z" fill="#005E6A"/>
                                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M73.9801 36.0719H79.75C79.75 36.0719 78.2007 36.8058 78.2007 37.4224C78.2007 41.6934 78.2007 48.7753 78.2007 53.0154C78.2007 53.6892 79.75 54.6414 79.75 54.6414H73.9801C73.9801 54.6414 75.4226 53.6675 75.4226 53.0154C75.4226 47.9236 75.4226 41.6934 75.4226 37.4224C75.4226 36.8296 73.9801 36.0719 73.9801 36.0719Z" fill="#005E6A"/>
                                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M35.8351 36.0719C35.8351 36.0719 37.331 36.8178 37.331 37.4224C37.331 41.6934 37.331 47.9236 37.331 53.0154C37.331 53.6782 35.8351 54.6414 35.8351 54.6414C35.8351 54.6414 43.3081 54.6414 44.383 54.6414C44.9173 54.6414 50.9008 53.663 50.9008 49.0499C50.9008 44.4369 46.2529 44.0049 46.2529 44.0049C46.2529 44.0049 49.0844 43.2177 49.0844 40.0616C49.0844 36.6596 44.9173 36.0719 44.383 36.0719C43.2728 36.0719 35.8351 36.0719 35.8351 36.0719ZM40.3762 43.6992V37.8938C40.3762 37.8938 42.8539 37.8938 43.8488 37.8938C44.383 37.8938 46.2529 38.5176 46.2529 40.8319C46.2529 42.7394 44.383 43.6992 43.8488 43.6992C42.6376 43.6992 40.3762 43.6992 40.3762 43.6992ZM40.3762 45.2218C40.3762 45.2218 43.8488 45.2218 44.383 45.2218C44.9173 45.2218 48.0693 46.0406 48.0693 48.7753C48.0693 51.5635 44.9173 52.5516 44.383 52.5516C43.8488 52.5516 40.3762 52.5516 40.3762 52.5516V45.2218Z" fill="#005E6A"/>
                                                            </g>
                                                            <defs>
                                                ...
                                                <div class="credit-card-inner">
                                                    <div class="credit-card-front">
                                                        ...
                                                        <svg width="92" height="92" viewBox="0 0 92 92" fill="none" xmlns="http://www.w3.org/2000/svg" class="logo">
                                                            ...
                                                            <rect width="67.5" height="21.039" fill="white" transform="translate(11.8125 35.4375)"/>
                                                            </clipPath>
                                                            </defs>
                                                            </svg>
                                                ...
                                                <div class="credit-card-inner">
                                                    <div class="credit-card-front">
                                                        ...
                                                        <svg width="92" height="92" viewBox="0 0 92 92" fill="none" xmlns="http://www.w3.org/2000/svg" class="logo">
                                                            ...
                                                            <rect width="91.125" height="91.125" rx="6.75" fill="white"/>
                                                            <path d="M45.2597 52.4801C55.3248 52.4801 63.4842 44.3208 63.4842 34.2557C63.4842 24.1906 55.3248 16.0312 45.2597 16.0312C35.1946 16.0312 27.0353 24.1906 27.0353 34.2557C27.0353 44.3208 35.1946 52.4801 45.2597 52.4801Z" fill="#00AED6"/>
                                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M55.8906 33.7242C55.7387 31.4461 53.7644 29.6237 51.4863 29.7755H39.9442C39.4886 29.7755 39.1848 29.4718 39.1848 29.0162C39.1848 28.5606 39.4886 28.2568 39.9442 28.2568H51.6382C51.5623 26.7381 50.4232 25.1435 48.9805 24.9157C45.5634 24.3082 42.0704 24.3082 38.7292 24.9157C36.8308 25.2194 35.3881 27.1178 35.0843 28.9403C34.5528 32.5092 34.5528 36.1541 35.0843 39.7231C35.464 41.7733 37.1346 43.4439 39.2608 43.7476C43.5131 44.2792 47.7655 44.2792 51.9419 43.7476C53.8403 43.5198 55.0553 41.7733 55.435 39.9509C55.8146 37.8247 55.9665 35.7744 55.8906 33.7242ZM52.0938 36.23V36.9135C52.0938 37.3691 51.7901 37.6728 51.3345 37.6728C50.8789 37.6728 50.5751 37.3691 50.5751 36.9135V36.23C50.3473 36.0022 50.1954 35.6985 50.1954 35.3947C50.1954 34.7873 50.727 34.2557 51.3345 34.2557C51.9419 34.2557 52.4735 34.7873 52.4735 35.3947C52.4735 35.6985 52.3216 36.0022 52.0938 36.23Z" fill="white"/>
                                                            <path d="M17.7711 70.7046C18.5305 71.8436 19.8214 72.4511 21.1882 72.3751C22.7829 72.3751 23.9219 71.388 23.9219 70.0212V69.2618C23.0866 70.0971 21.8716 70.5527 20.6567 70.4768C17.6952 70.5527 15.2653 68.2746 15.1893 65.3132C15.1134 62.3517 17.3915 59.9218 20.3529 59.8458C20.4289 59.8458 20.5048 59.8458 20.5807 59.8458C21.7957 59.7699 23.0107 60.2255 23.9219 61.0608V60.0736H26.6556V69.9452C26.6556 72.8308 24.3775 74.8051 21.1882 74.8051C19.062 74.9569 17.0877 74.0457 15.7209 72.3751L17.7711 70.7046ZM23.846 64.5538C23.846 63.4148 22.5551 62.3517 21.1123 62.3517C19.2898 62.3517 18.0749 63.4907 18.0749 65.1613C17.9989 66.6041 19.062 67.895 20.5807 68.0468C20.7326 68.0468 20.8845 68.0468 21.0364 68.0468C22.631 68.0468 23.9219 67.0597 23.9219 65.8447V64.5538H23.846Z" fill="black"/>
                                                            <path d="M33.7935 59.7699C37.1346 59.7699 39.4886 62.1239 39.4886 65.1613C39.4886 68.1987 37.0587 70.5527 33.7935 70.5527C30.832 70.7046 28.2502 68.4265 28.0983 65.465C27.9465 62.5036 30.1486 59.9218 33.1101 59.7699C33.3379 59.7699 33.5657 59.7699 33.7935 59.7699ZM33.7935 62.2758C32.1988 62.2758 30.9079 63.5667 30.9079 65.1613C30.9079 66.7559 32.1988 68.0468 33.7935 68.0468C35.3881 68.0468 36.679 66.7559 36.679 65.1613C36.755 63.6426 35.54 62.3517 34.0972 62.2758C33.9454 62.2758 33.8694 62.2758 33.7935 62.2758Z" fill="black"/>
                                                            <path d="M41.0833 60.0736H43.8169V60.9849H43.8929C44.8041 60.1496 45.9431 59.7699 47.1581 59.7699C50.1195 59.8458 52.4735 62.2758 52.3976 65.2372C52.3217 68.1228 50.0436 70.4008 47.1581 70.4768C46.019 70.4768 44.88 70.0971 43.9688 69.4137H43.8929V74.5013H41.0833V60.0736ZM46.6265 62.2758C45.1078 62.2758 43.8929 63.3389 43.8929 64.4779V65.7688C43.8929 66.9837 45.1078 67.9709 46.7025 67.9709C48.2971 67.9709 49.588 66.68 49.5121 65.0854C49.5121 63.5667 48.2212 62.2758 46.6265 62.2758Z" fill="black"/>
                                                            <path d="M57.7131 64.1741C59.5355 63.9463 60.143 63.6426 60.143 63.111C60.143 62.4276 59.4596 62.048 58.3206 62.048C57.1815 61.972 56.0425 62.7314 55.8147 63.8704L53.157 63.3389C53.5367 61.2886 55.6628 59.7699 58.3206 59.7699C61.282 59.7699 63.1045 61.2886 63.1045 63.7185V70.173H60.4468V69.034C59.6115 70.0211 58.3206 70.5527 57.0297 70.4008C54.8276 70.4008 53.2329 69.1859 53.2329 67.3634C53.2329 65.541 54.4479 64.6298 57.7131 64.1741ZM60.2949 65.2372C59.9912 65.6169 59.4596 65.8447 58.0928 66.0725C56.4222 66.3763 55.8147 66.68 55.8147 67.2875C55.8147 67.895 56.3463 68.1987 57.4094 68.1987C59.004 68.1987 60.2949 67.4394 60.2949 66.4522V65.2372Z" fill="black"/>
                                                            <path d="M68.1162 69.6416L63.4841 60.0737H66.5975L69.7108 66.6801H69.7868L72.8242 60.0737H75.9375L68.9515 74.5014H65.7622L68.1162 69.6416Z" fill="black"/>
                                                            </g>
                                                            <defs>
                                                ...
                                                <div class="credit-card-inner">
                                                    <div class="credit-card-front">
                                                        ...
                                                        <svg width="92" height="92" viewBox="0 0 92 92" fill="none" xmlns="http://www.w3.org/2000/svg" class="logo">
                                                            ...
                                                            <rect width="67.5" height="19.2993" fill="white" transform="translate(11.8125 36.2812)"/>
                                                            </clipPath>
                                                            </defs>
                                                            </svg>
                                                ...
                                                <div class="credit-card-inner">
                                                    <div class="credit-card-front">
                                                        ...
                                                        <svg width="92" height="92" viewBox="0 0 92 92" fill="none" xmlns="http://www.w3.org/2000/svg" class="logo">
                                                            ...
                                                            <rect width="67.5" height="29.5516" fill="white" transform="translate(11.8125 30.375)"/>
                                                            </clipPath>
                                                            </defs>
                                                            </svg>
